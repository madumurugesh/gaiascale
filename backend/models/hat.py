"""
HAT: Hybrid Attention Transformer for Image Super-Resolution (Chen et al., CVPR 2023)
Adapted for 4-band Multispectral Satellite Imagery [B04 (Red), B03 (Green), B02 (Blue), B08 (NIR)].

Key Architectural Innovations for Satellite SRM:
...
3. Overlapping Cross-Attention Block (OCAB): Eliminates window boundary artifacts without blocking seams.
...
class HAT(nn.Module):
    """
    Hybrid Attention Transformer (HAT) for 4-Band Multispectral Super-Resolution Mapping.
    Outputs:
